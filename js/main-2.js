/*********************************************************
Geography 575 Lab 3: Coordinated Visualization using D3
Copyright (c) March 2013, Carl Sack and the University of Wisconsin-Madison Cartography Program
MIT License
**********************************************************/

var expressed = "varA"; //initial attribute expressed
...
function setMap(){
	...
	var graticule = d3.geo.graticule()
		.step([1, 1]); //place graticule lines every 10 degrees of longitude and latitude
	...
	var gratLines = map.selectAll(".graticule") //select graticule elements that will be created
	...
	// d3.csv("data/unitsData.csv", function(csvData){
		...
		d3.json("data/wisc-counties-topo2.json", function(error, wiscCounties) {
			...
			var countries = map.append("path") //create SVG path element
				.datum(topojson.object(wiscCounties, wiscCounties.objects.counties)) //bind countries data to path element
...
// function choropleth(d, recolorMap){
	...
	// //<-setMap d3.json provinces.append("desc").text
...
// function dehighlight(data){
	// //<-setMap d3.json svg.selectAll(".provinces").on("mouseout"...
...
// function moveLabel() {
	// //<-setMap d3.json provinces.on("mousemove"...
